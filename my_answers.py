...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        # dot product between features matrix and input to hidden weights 
        hidden_inputs = np.dot(X, self.weights_input_to_hidden) # signals into hidden layer
        
        # calculate sigmoid activation function  for hidden input 
        hidden_outputs = self.activation_function(hidden_inputs) # signals from hidden layer

        # TODO: Output layer - Replace these values with your calculations.
        # dot product between hidden outputs matrix and hidden to output weights 
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # calculate error by subtraction true y and predict y 
        error = y - final_outputs # Output layer error is the difference between desired target and actual output.
        
    
        # TODO: Backpropagated error terms - Replace these values with your calculations.
        # the derivative sigmoid activation function f(x) = x is 1
        output_error_term = error
        
        
        # TODO: Calculate the hidden layer's contribution to the error
        # dot product between output error term  and hidden to output weights 
